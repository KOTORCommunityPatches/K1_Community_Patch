...
* After giving the moisture vaporators to the Chieftain in the Tatooine Sand People Enclave, they could drop as loot if the Sand People turned hostile (Reported by La Ingobernable) [ISSUE #630](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/630)
...
* Bastila's shuttle on the Unknown World Temple Summit was a bit too close to the walls (Reported by La Ingobernable) [ISSUE #644](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/644)
...
* During the post-ending cutscenes in the Kashyyyk Landing Pad the party was disorganised, NPCs could run into each other, and scenes could trigger out of order (With input from JCarter426) [ISSUE #119](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/119)
...
* Ithorak fought with his fists and used the wrong soundset when attacked in the Manaan Docking Bay (Reported by Salk) [ISSUE #398](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/398)
...
* One of Admiral Dodonna's endgame cutscenes didn't use the correct labels for the participants in the scene (Reported by nt7788) [ISSUE #420](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/420)
...
* The cutscene of the party approaching the ruins in the Dantooine Jedi Enclave Courtyard could trigger without Bastila in the party (Reported by La Ingobernable) [ISSUE #608](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/608)
...
* The female player head PFHA04 had some hair accessory texture issues for the Dark Side transitions (Reported by La Ingobernable) [ISSUE #653](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/653)
...
* The female player head PFHC01 had some eyeball texture issues for the Dark Side transitions (Reported by La Ingobernable) [ISSUE #652](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/652)
* The female player head PFHC01 had some eyelid clipping issues during certain facial animations (Reported by La Ingobernable) [ISSUE #467](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/467)
* The female player head PFHC03 had some eyeball texture issues for the Dark Side transitions (Reported by La Ingobernable) [ISSUE #652](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/652)
...
* The old black male head 2 had some poorly positioned UVs for the eyelids and mouthbox (Reported by La Ingobernable) [ISSUE #622](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/622)
...
* The rough-cut Upari amulet gained in the Kashyyyk Lower Shadowlands was needlessly set as a quest item (Reported by La Ingobernable) [ISSUE #638](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/638)
...
* The sword of Ajunta Pall and the ceremonial lightsaber needlessly remained quest items after completing Korriban (Reported by La Ingobernable) [ISSUE #638](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/638)
...
* When encountering Calo Nord in the Korriban Valley of the Dark Lords, one of his thugs showed little interest and could wander off (Reported by La Ingobernable) [ISSUE #645](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/645)
...
* When interacting with Zuulan's speeder in Dantooine Matale Grounds, the conversation would exit abruptly if lacking a frag mine, and the invisible placeable name showed in the Feedback screen [ISSUE #553](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/553)
* When Lurze left post-conversation in Korriban Dreshdae, he went the long way and could skate along the floor briefly [ISSUE #529](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/529)
* When meeting The One for the first time on the Unknown World, the party members could panic about being left behind [ISSUE #477](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/477)
* When re-entering Korriban Dreshdae and encountering the Sith murderer, he constantly turned to face the player and the party was on the other side of the room [ISSUE #283](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/283)
* When re-entering Korriban Dreshdae and encountering the Sith thugs, they played their ambient animations and had facing issues [ISSUE #282](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/282)
...
* When returning to the Kashyyyk Great Walkway after agreeing to help Freyyr, the party was scattered when talking to Chorrawl [ISSUE #536](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/536)
...
* When solving the floor puzzle in the Unknown World Temple Catacombs, the initial cutscene could be triggered repeatedly until the puzzle was complete [ISSUE #338](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/338)
* When speaking to Largo in the Taris Upper City North Apartments, one of Carth's interjections was off-screen (Reported by KnifeMaster) [ISSUE #299](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/299)
...
* When speaking to the Storyteller in the Tatooine Sandpeople Enclave, one of HK's lines was cut short and he keep switching his facing [ISSUE #221](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/221)
* When speaking with Igear in the Taris Undercity, there were some facing issues, especially after Carth's interjections [ISSUE #482](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/482)
...
* A Sith captain in the Manaan Sith Base was assign an incorrect soundset [ISSUE #141](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/141)
...
* Some Sith Elite Troopers in the Manaan Docking Bay incorrectly used the Officer appearance (Reported by JCarter426) [ISSUE #183](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/183)
...
### JCarter426:
* A typo prevented various NPCs from commenting on the Kashyyyk situation: [JC's Jedi Tailor for K1 1.1](https://deadlystream.com/files/file/1477-jcs-jedi-tailor-for-k1/)
...
* Korriban NPCs that loop animations—students meditating in the academy and archaeologists digging in the valley—would turn to face the player while still doing their animations: [JC's Korriban: Back in Black for K1 2.2](https://deadlystream.com/files/file/1293-jcs-korriban-back-in-black-for-k1/)
...
* Sith fighter lasers were the wrong color: [JC's Minor Fixes for K1 1.1](https://deadlystream.com/files/file/1333-jcs-minor-fixes-for-k1/)
* Some guards on Korriban had weapons in their inventory, but not equipped: [JC's Korriban: Back in Black for K1 2.2](https://deadlystream.com/files/file/1293-jcs-korriban-back-in-black-for-k1/)
* Some Korriban NPCs' genders were incorrect: [JC's Korriban: Back in Black for K1 2.2](https://deadlystream.com/files/file/1293-jcs-korriban-back-in-black-for-k1/)
* Some male commoner clothing variants have been improved: [JC's Minor Fixes for K1 1.1](https://deadlystream.com/files/file/1333-jcs-minor-fixes-for-k1/)
...
* The quality of the Sith soldier placeable texture has been improved based on the higher-resolution Sith soldier NPC texture [JC's Minor Fixes for K1 1.1](https://deadlystream.com/files/file/1333-jcs-minor-fixes-for-k1/)
* The Republic soldier body models have been improved: [JC's Republic Soldier Fix for K1 1.3](https://deadlystream.com/files/file/1180-jcs-republic-soldier-fix-for-k1/) (with DarthParametric lending a hand)
...
* Some plot-specific doors in the temple on the Unknown World erroneously showed the Security UI (With input from DarthParametric) [ISSUE #442](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/442)
