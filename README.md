...
* The scene with the infected Republic soldier in the Taris Undercity had some issues with animations and Rakghouls not attacking (Reported by Salk) [ISSUE #666](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/666)
...
* There were some facing issues during the post-Hrakert Rift trial in Manaan Ahto West [ISSUE #136](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/136)
...
* When encountering the Sith Master and his Selkath apprentices in the Manaan Sith Base, there were issues with facing and camera angles during companion interjections [ISSUE #141](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/141)
...
* When Jolee encountered his messenger Davin on Manaan, he would refer to the player as his "old friend", despite not doing so on other planets [ISSUE #709](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/709)
* When Jolee was chosen to break out the party in the Leviathan Prison Block, there were some issues with facing and animation timing during his starting scene [ISSUE #145](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/145)
...
* When meeting Carth face-to-face in the Endar Spire Starboard Section, he sometimes wouldn't face the player [ISSUE #490](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/490)
...
* When opening the door in front of the steam vents in the Manaan Sith Base, the opener would face off to one side [ISSUE #141](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/141)
* When overloading the harvesting machine in Manaan Hrakert Rift, the external camera shots didn't focus on the appropriate pod as intended [ISSUE #524](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/524)
...
* When returning to Roland Wann in Manaan East Central after completing Hrakert Rift, some unneeded quest items were not removed [ISSUE #142](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/142)
...
* When returning to the Taris Hideout after the swoop race, there was a jarring transition between the two conversations with Bastila [ISSUE #254](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/254)
...
* When speaking to Sunry in the Manaan Ahto West jail, one of his lines had incorrect subtitles and another didn't flow well from the previous line [ISSUE #523](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/523)
* When speaking to Sunry in the Manaan Ahto West jail, the party members could be scattered, causing Jolee to skate along the floor [ISSUE #523](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/523)
* When speaking to Sunry in the Manaan Ahto West jail, there was a missing persuasion check for asking about his relationship with Elassa (Reported by Salk) [ISSUE #383](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/383)
* When speaking to Tanis in the Tatooine Dune Sea for the first time, he sometimes wouldn't react to the speaker wearing the Sandpeople disguise (Reported by Markus Ramikin) [ISSUE #690](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/690)
* When speaking to the judges in the Manaan Ahto West courtroom, companion interjections could be spoken off-screen and the party could be scattered [ISSUE #136](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/136)
...
* When talking to Gendar in Taris Undercity the party was scattered and ambient NPCs could barge right through [ISSUE #722](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/722)
...
* When talking to Mission in Taris Javyar's Cantina after her run-in with the "greenies", the party could be scattered and Zaalbar could have trouble pathfinding past them afterwards [ISSUE #495](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/495)
* When talking to Rukil in Taris Undercity the party was scattered, they didn't follow him to Gendar, and ambient NPCs could barge right through [ISSUE #501](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/501)
* When talking to the Jawa Iziz in Tatooine Anchorhead there were facing issues with party member interjections (Reported by muitafruita) [ISSUE #618](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/618)
...
* When the player defied Saul during the interrogation scene in the Leviathan Prison Block, the shots of Bastila or Carth being tortured didn't sync with their animations [ISSUE #145](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/145)
* When the player reached the end of the Star Forge Command Center, they could freeze at the end of the scene and the two captives didn't always play their animations [ISSUE #173](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/173)
...
* The player's name in message logs was incorrect following the swoop race (Reported by Crimson Knight) [ISSUE #685](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/685)
...
* After rescuing Hendar in the Taris Undercity, you could miss a Light Side alignment gain if you spoke to him instead of Hester (Reported by zappepappe) [ISSUE #680](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/680)
...
* One of the dialogue choices for betraying both Uthar and Yuthura in the Korriban Tomb of Naga Sadow could leave the associated quest in an orphaned state (Reported by StuckInMyPants) [ISSUE #696](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/696)
...
* The flow control room in the Manaan Sith Base had a missing door and the door of the adjoining room was mislabelled [ISSUE #353](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/353)
...
* The Star Map placeable didn't have the correct sound effect for its deactivation animation [ISSUE #757](https://github.com/KOTORCommunityPatches/K1_Community_Patch/issues/757)
