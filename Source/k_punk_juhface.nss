...
/*	KOTOR Community Patch
	...
	k_punk_cut02, k_punk_faceall, k_punk_joleeface, k_punk_misfacep2, k_punk_misfacepc,
	k_punk_pcwalk.
...
void main() {
	...
	AssignCommand(oJuhani, SetFacingPoint(GetPosition(GetObjectByTag("centerface", 0))));
	AssignCommand(oPC, SetFacingPoint(GetPosition(GetObjectByTag("centerface", 0))));
}
