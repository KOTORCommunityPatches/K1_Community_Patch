...
/*	KOTOR Community Patch
	...
	cp_unk41_csface5, cp_unk41_misdies, cp_unk41_pause1s, k_def_gizka02, k_punk_carrun,
...
void main() {
	...
	AssignCommand(oJuh, SetFacingPoint(GetPosition(oPC)));
	AssignCommand(oJuh, ActionPlayAnimation(ANIMATION_LOOPING_TALK_NORMAL, 1.0, 0.1));
	...
	AssignCommand(oCarth, SetFacingPoint(GetPosition(oJuh)));
	AssignCommand(oCarth, ActionPlayAnimation(ANIMATION_LOOPING_LISTEN, 1.0, 0.1));
}
