...
/*	KOTOR Community Patch
	...
	OnOpen for cp_man27aa_dr08.utd in manm27aa (Manaan Sith Base).
	
	This is the OnOpen script for an the door that replaces the back entrance of
	...
	See also cp_man27aa_dr07, k_pman_27_init01.
