...
/*	KOTOR Community Patch
	...
	This is the starting conditional script that gates Bastila's fifth romance
	dialogue (I'd like to know more about you, Bastila). Unlike most of the rest
	of her romance scripts, this one (and k_swg_bastila03) lack the check for the
...
int StartingConditional() {
	...
	if (iResult == 4 && nPlot > 9 && nLevel > nLastLevel)
		{
			return TRUE;
		}
