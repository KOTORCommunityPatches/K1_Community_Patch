...
/*	KOTOR Community Patch
	...
	This script has been added to Dustil's DLG to force Carth to face him
	while speaking his lines. Previously he would face the player. It also
	jumps the party into fixed positions, to try and cut down on the usual
	conversation screwiness and locks the PC to prevent them turning to
	face Carth on his lines.
