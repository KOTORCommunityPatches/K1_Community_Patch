...
/*	KOTOR Community Patch
	...
	See also cp_unk41_csface1, cp_unk41_csface2, cp_unk41_csface4, cp_unk41_csface5,
...
void main() {
	...
	AssignCommand(oZaal, SetFacingPoint(GetPosition(oMiss)));
	AssignCommand(oMiss, SetFacingPoint(GetPosition(oZaal)));
}
