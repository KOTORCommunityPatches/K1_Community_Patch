...
void main() {
	...
	object oUthar = GetObjectByTag("kor39_uthar", 0);
	...
	ChangeToStandardFaction(oYuthura, STANDARD_FACTION_FRIENDLY_1);
	
	SetGlobalNumber("KOR39_SITH_HOSTILE", 2);
	...
	DelayCommand(1.0, AssignCommand(oYuthura, GN_DetermineCombatRound(oUthar)));
}
