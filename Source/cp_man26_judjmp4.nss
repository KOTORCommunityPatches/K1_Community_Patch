...
/*	KOTOR Community Patch
	...
	Fired by man26_seljud4.dlg in manm26aa (Manaan Ahto West).
	
	This added script fires on most of the first nodes of each branch of the DLG
	for Judge Kota in the courtroom, jumping the party into position to help
	alleviate facing and camera angle issues.
	
	See also cp_man26_judjmp1, cp_man26_judjmp2, cp_man26_judjmp3, cp_man26_judjmp5.
...
void main() {
	...
	object oJudge = GetObjectByTag("man26_seljud4");
	location lPC = Location(Vector(60.76,-1.66,59.16), 30.00);
	location lPM1 = Location(Vector(60.76,-0.16,59.16), -30.00);
	location lPM2 = Location(Vector(59.89,-0.91,59.16), 0.00);
