...
/*	KOTOR Community Patch
	...
	See also cp_unk41_csface2, cp_unk41_csface3, cp_unk41_csface4, cp_unk41_csface5,
...
void main() {
	...
	AssignCommand(oPC, SetFacingPoint(GetPosition(GetObjectByTag("carth", 0))));
	AssignCommand(oPC, ActionPlayAnimation(ANIMATION_LOOPING_LISTEN, 1.0, 1.0));
	
	AssignCommand(GetObjectByTag("mission", 0), ActionPlayAnimation(ANIMATION_LOOPING_LISTEN, 1.0, 1.0));
