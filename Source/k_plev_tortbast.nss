...
/*	KOTOR Community Patch
	...
	This is the script that fires the first time a male PC refuses to answer Saul
	during the Leviathan interrogation cutscene, causing Bastila to be tortured.
	It has been tweaked to ensure that she animates for the full length of the
	shot.
	
	See also k_plev_tortbast2, k_plev_tortbast3, k_plev_tortcarth, k_plev_tortcarth2,
	k_plev_tortcarth3.
