...
/*	KOTOR Community Patch
	...
	the player has not visited The One's settlement first, thus setting them hostile.
	It walks the player towards the	council in a wide shot. It has been tweaked to
	walk the entire party to fixed positions.
	
	See also k_punk_eldspk, k_punk_rakeld01.
