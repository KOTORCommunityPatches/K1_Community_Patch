...
/*	KOTOR Community Patch
	...
	Updated 2019-05-02 to make the script conditional on Carth being present,
	since it was desirable to move it from his specific nodes and fire it on
	the preceding line to avoid any visible realignments. The scene has been
	further adjusted with a forcible placement of the party, so Carth's facing
	sins are less egregious now.
